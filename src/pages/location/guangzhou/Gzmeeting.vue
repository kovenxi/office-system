    ...
    <div class="main">
      <div class="container">
        <div class="banner">
          ...
          <div class="title">广州中华国际中心</div>
          <div class="title2">会议室</div>
        </div>
        <div class="content clearfix">
          <div class="rotation">
            <ul class="slides">
              ...
              <li class="slide"><img src="../locationsrc/img/gzmeeting1.webp"></li>
              <li class="slide"><img src="../locationsrc/img/gzmeeting2.webp"></li>
              <li class="slide"><img src="../locationsrc/img/gzs3.webp"></li>
              <li class="slide"><img src="../locationsrc/img/gzs4.webp"></li>
              <div class="controls">
...
export default {
  ...
  methods :{
    ...
    sure(){
      let list = {}
      list.title = '广州中华国际中心-会议室'
      list.stime = this.startTime
      list.etime = this.endTime
      list.pic = require('@/pages/location/locationsrc/img/gzmeeting1.webp')
      list.htype = '>=20'
      list.num = this.num
      list.price = 20
      list.priceType = '人/时'
      list.fprice = this.final
      list.path = '/guangzhou/gzdetail/gzmeeting'
