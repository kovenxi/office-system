        ...
        <div class="content clearfix">
          <div class="rotation">
            <ul class="slides">
              ...
              <li class="slide"><img src="../locationsrc/img/shs1.webp"></li>
              <li class="slide"><img src="../locationsrc/img/shs2.webp"></li>
...
export default {
  ...
  methods :{
    ...
    sure(){
      let list = {}
      list.title = '上海来福士广场-共享办公室'
      list.stime = this.startTime
      list.etime = this.endTime
      list.pic = require('@/pages/location/locationsrc/img/shs1.webp')
      list.htype = '>=20'
      list.num = this.num
      list.price = 20
      list.priceType = '人/时'
      list.fprice = this.final
      list.path = '/shanghai/shdetail/shshared'
