        ...
        <div class="content clearfix">
          <div class="rotation">
            <ul class="slides">
              ...
              <li class="slide"><img src="../locationsrc/img/szind1.webp"></li>
              <li class="slide"><img src="../locationsrc/img/szind2.webp"></li>
...
export default {
  ...
  methods :{
    ...
    sure(){
      let list = {}
      list.title = '深圳安联中心-独立办公室'
      list.stime = this.startTime
      list.etime = this.endTime
      list.pic = require('@/pages/location/locationsrc/img/szind1.webp')
      list.htype = '>=20'
      list.num = this.num
      list.price = 20
      list.priceType = '人/时'
      list.fprice = this.final
      list.path = '/shenzhen/szdetail/szind'
