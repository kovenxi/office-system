        ...
        <div class="content clearfix">
          <div class="rotation">
            <ul class="slides">
              ...
              <li class="slide"><img src="../locationsrc/img/bjind1.webp"></li>
              <li class="slide"><img src="../locationsrc/img/bjind2.webp"></li>
...
export default {
  ...
  methods :{
    ...
    sure(){
      let list = {}
      list.title = '北京新东安广场-独立办公室'
      list.stime = this.startTime
      list.etime = this.endTime
      list.pic = require('@/pages/location/locationsrc/img/bjind1.webp')
      list.htype = '>=20'
      list.num = this.num
      list.price = 20
      list.priceType = '人/时'
      list.fprice = this.final
      list.path = '/beijing/bjdetail/bjind'
