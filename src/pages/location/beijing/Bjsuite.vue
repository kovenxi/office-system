    ...
    <div class="main">
      <div class="container">
        <div class="banner">
          ...
          <div class="title">北京新东安广场</div>
          <div class="title2">办公套间</div>
        </div>
        <div class="content clearfix">
          <div class="rotation">
            <ul class="slides">
              ...
              <li class="slide"><img src="../locationsrc/img/bjsuite1.webp"></li>
              <li class="slide"><img src="../locationsrc/img/bjsuite2.webp"></li>
              <li class="slide"><img src="../locationsrc/img/bjs3.webp"></li>
              <li class="slide"><img src="../locationsrc/img/bjs4.webp"></li>
              <div class="controls">
...
export default {
  ...
  methods :{
    ...
    sure(){
      let list = {}
      list.title = '北京新东安广场-办公套间'
      list.stime = this.startTime
      list.etime = this.endTime
      list.pic = require('@/pages/location/locationsrc/img/bjsuite1.webp')
      list.htype = '>=20'
      list.num = this.num
      list.price = 20
      list.priceType = '人/时'
      list.fprice = this.final
      list.path = '/beijing/bjdetail/bjsuite'
      this.$store.commit('addBuyList',list)
    },
    sure2(){
      let list = {}
      list.title = '北京新东安广场-会办公套间'
      list.stime = this.startTime
      list.etime = this.endTime
      list.pic = require('@/pages/location/locationsrc/img/bjsuite1.webp')
      list.htype = '>=20'
