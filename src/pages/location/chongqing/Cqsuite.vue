        ...
        <div class="content clearfix">
          <div class="rotation">
            <ul class="slides">
              ...
              <li class="slide"><img src="../locationsrc/img/cqsuite1.webp"></li>
              <li class="slide"><img src="../locationsrc/img/cqsuite2.webp"></li>
...
export default {
  ...
  methods :{
    ...
    sure(){
      let list = {}
      list.title = '重庆中国人保寿险大厦-办公套间'
      list.stime = this.startTime
      list.etime = this.endTime
      list.pic = require('@/pages/location/locationsrc/img/cqsuite1.webp')
      list.htype = '>=20'
      list.num = this.num
      list.price = 20
      list.priceType = '人/时'
      list.fprice = this.final
      list.path = '/chongqing/cqdetail/cqsuite'
