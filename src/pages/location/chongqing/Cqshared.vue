        ...
        <div class="content clearfix">
          <div class="rotation">
            <ul class="slides">
              ...
              <li class="slide"><img src="../locationsrc/img/cqs1.webp"></li>
              <li class="slide"><img src="../locationsrc/img/cqs2.webp"></li>
          ...
          <div class="inform">  
            ...
            <div class="btn">
              <button class="buy" @click="buy()">立即租用</button>
...
export default {
  ...
  methods :{
    ...
    sure(){
      let list = {}
      list.title = '重庆中国人保寿险大厦-共享办公室'
      list.stime = this.startTime
      list.etime = this.endTime
      list.pic = require('@/pages/location/locationsrc/img/cqs1.webp')
      list.htype = '>=20'
      list.num = this.num
      list.price = 20
      list.priceType = '人/时'
      list.fprice = this.final
      list.path = '/chongqing/cqdetail/cqshared'
