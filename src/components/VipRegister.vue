<template>
  <div id = 'login'>
    ...
    <el-form  :rules="rules" ref="ruleform" :model="loginForm" class='loginContainer'>
      <h3 class="loginHead" style="margin-bottom:10px;">会员注册</h3>
      <el-form-item prop="username">
          <el-input tpye="text" autocomplete="false" v-model="loginForm.username" placeholder="请输入会员ID"></el-input>
      </el-form-item>
      ...
      <el-button tpye="primary" style="width:100%" @click="submit();test()">确定</el-button>
    </el-form>
  ...
  export default {
    data(){
      return{
        ...
        rules:{
          username:[{required:true,message:'请输入会员ID',trigger:'blur'}],
